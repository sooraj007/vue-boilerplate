...
import ***REMOVED*** ServerTable, ClientTable, Event ***REMOVED*** from 'vue-tables-2'
...
//import ***REMOVED***site***REMOVED*** from './assets/js/site.scripts.js'
import hydroscripts  from './assets/js/site.scripts.js'
...
Vue.use(ElementUI, ***REMOVED***locale***REMOVED***)
...
new Vue(***REMOVED***
  ...
  router,
  template: '<App/>',
  components: ***REMOVED***App***REMOVED***
***REMOVED***)
